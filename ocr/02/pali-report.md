...
| compound analyses romanised | 5,707 |
| of which every element Pāḷi-shaped | 5,287 = 92.6% (the rest keep Burmese parts in ⟨ ⟩) |
| articles with Pāḷi found in the definition | 6,051 = 84.2% |
| Pāḷi spans | 27,851 |
| tokens in those spans | 107,553, of which **88.5% attested in OSBCT** |
