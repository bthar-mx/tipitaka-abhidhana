...
| compound analyses romanised | 5,820 |
| of which every element Pāḷi-shaped | 5,394 = 92.7% (the rest keep Burmese parts in ⟨ ⟩) |
| articles with Pāḷi found in the definition | 6,714 = 91.1% |
| Pāḷi spans | 23,548 |
| tokens in those spans | 83,712, of which **93.1% attested in OSBCT** |
