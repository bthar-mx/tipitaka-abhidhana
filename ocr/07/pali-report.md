...
| compound analyses romanised | 5,231 |
| of which every element Pāḷi-shaped | 4,781 = 91.4% (the rest keep Burmese parts in ⟨ ⟩) |
| articles with Pāḷi found in the definition | 5,937 = 86.3% |
| Pāḷi spans | 20,614 |
| tokens in those spans | 71,750, of which **87.4% attested in OSBCT** |
| citations romanised (mechanically, abbreviations not expanded) | 18,959 |
