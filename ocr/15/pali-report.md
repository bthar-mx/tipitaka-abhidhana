# Vol. 15 — romanised Pāḷi

*`tools/abhidhana_romanise.py 15` over `articles.jsonl`. Aksharamukha Burmese → IAST, ṃ written ṁ.
Output: `pali.jsonl`, one row per article, keyed by `id`.*

| | |
|---|---:|
| headwords romanised | 9,342 (all) |
| compound analyses romanised | 7,136 |
| of which every element Pāḷi-shaped | 6,413 = 89.9% (the rest keep Burmese parts in ⟨ ⟩) |
| articles with Pāḷi found in the definition | 8,017 = 85.8% |
| Pāḷi spans | 22,164 |
| tokens in those spans | 72,136, of which **85.4% attested in OSBCT** |
| citations romanised (mechanically, abbreviations not expanded) | 15,388 |
