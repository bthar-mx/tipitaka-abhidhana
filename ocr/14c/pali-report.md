...
| compound analyses romanised | 6,209 |
| of which every element Pāḷi-shaped | 5,984 = 96.4% (the rest keep Burmese parts in ⟨ ⟩) |
| articles with Pāḷi found in the definition | 9,096 = 87.5% |
| Pāḷi spans | 27,059 |
| tokens in those spans | 107,520, of which **89.7% attested in OSBCT** |
