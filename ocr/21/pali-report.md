# Vol. 21 — romanised Pāḷi

*`tools/abhidhana_romanise.py 21` over `articles.jsonl`. Aksharamukha Burmese → IAST, ṃ written ṁ.
Output: `pali.jsonl`, one row per article, keyed by `id`.*

| | |
|---|---:|
| headwords romanised | 8,129 (all) |
| compound analyses romanised | 6,559 |
| of which every element Pāḷi-shaped | 6,092 = 92.9% (the rest keep Burmese parts in ⟨ ⟩) |
| articles with Pāḷi found in the definition | 7,576 = 93.2% |
| Pāḷi spans | 22,919 |
| tokens in those spans | 80,936, of which **92.2% attested in OSBCT** |
| citations romanised (mechanically, abbreviations not expanded) | 15,933 |
