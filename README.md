...
desde el birmano y nunca a través del inglés, está en borrador para los vols. 1–3, 4/1, 4/2, 5–13 y 14/1, sin revisar
...
4. **Spanish**, translated **from the Burmese**, never through English. Drafted, not reviewed, for vols. 1–3,
   4/1, 4/2, 5–13 and 14/1 (`docs/translation/meanings/`); see [`docs/spanish-method.md`](docs/spanish-method.md).
